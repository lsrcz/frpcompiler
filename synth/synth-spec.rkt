...
(interpret-spec sprinkler-spec trace-input bindings)
...
(define (synthesize-spec spec bindings sym-trace init-trace init-result annotate-func)
  (define (iter inout last-model)
    ...
    (displayln (interpret-spec spec sym-trace bindings))
...
;(synthesize-spec sprinkler-spec symbolic-bindings sym-trace annotate-func)
(displayln sym-trace)
(displayln (interpret-spec sprinkler-spec sym-trace symbolic-bindings))
